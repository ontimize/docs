---
title: "One tenant only"
layout: default
permalink: /systems/keycloak/one-tenant
...
We need a [Keycloak](https://www.keycloak.org/) instance, then we must configure a realm with a client, a role and a user. For the examples we will use the next settings:
